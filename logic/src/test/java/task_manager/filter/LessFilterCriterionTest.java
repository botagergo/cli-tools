...
import task_manager.logic.filter.LessFilterCriterion;
...
public class LessFilterCriterionTest {
    ...
    public LessFilterCriterionTest() throws IOException {
    ...
    private boolean checkNullsFirst(String propertyName, Object operand) throws IOException, PropertyException {
        return new LessFilterCriterion(propertyName, Property.fromUnchecked(propertyDescriptorRepository.get(propertyName), operand), nullsFirstPropertyComparator)
    ...
    private boolean checkNullsLast(String propertyName, Object operand) throws IOException, PropertyException {
        return new LessFilterCriterion(propertyName, Property.fromUnchecked(propertyDescriptorRepository.get(propertyName), operand), nullsLastPropertyComparator)
                .check(propertyOwner, propertyManager);
    }
