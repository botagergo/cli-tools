...
import task_manager.logic.filter.GreaterFilterCriterion;
...
public class GreaterFilterCriterionTest {
    ...
    public GreaterFilterCriterionTest() throws IOException {
    ...
    private boolean checkNullsFirst(String propertyName, Object operand) throws IOException, PropertyException {
        return new GreaterFilterCriterion(propertyName, Property.fromUnchecked(propertyDescriptorRepository.get(propertyName), operand), nullsFirstPropertyComparator)
    ...
    private boolean checkNullsLast(String propertyName, Object operand) throws IOException, PropertyException {
        return new GreaterFilterCriterion(propertyName, Property.fromUnchecked(propertyDescriptorRepository.get(propertyName), operand), nullsLastPropertyComparator)
                .check(propertyOwner, propertyManager);
    }
