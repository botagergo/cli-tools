...
import cli_tools.common.backend.service.PropertyOwnerImpl;
...
public class PropertySorterTest {
    ...
    @Test
    void test_PropertySorter_sort_propertyNotComparable() {
        Assert.assertThrows(PropertyNotComparableException.class, () ->
