...
public class ObjectDeserializerTest {
    ...
    @Test
    void test_deserialize_valid_int() throws JsonProcessingException {
        assertEquals(objectMapper.readValue("123", Object.class), 123);
    }

    @Test
    void test_deserialize_valid_boolean() throws JsonProcessingException {
        assertEquals(objectMapper.readValue("true", Object.class), true);
        assertEquals(objectMapper.readValue("false", Object.class), false);
    }

    @Test
    void test_deserialize_valid_string() throws JsonProcessingException {
    ...
    @Test
    void test_deserialize_valid_emptyString() throws JsonProcessingException {
        assertEquals(objectMapper.readValue("\"s:\"", Object.class), "");
        assertEquals(objectMapper.readValue("\"s:str\"", Object.class), "str");
    }

    @Test
    void test_deserialize_valid_uuid() throws JsonProcessingException {
        assertEquals(objectMapper.readValue("\"u:" + uuid1.toString() + "\"", Object.class), uuid1);
    }

    @Test
    void test_deserialize_valid_null() throws JsonProcessingException {
        assertNull(objectMapper.readValue("null", Object.class));
    }

    @Test
    void test_deserialize_valid_int_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_string_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_boolean_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_uuid_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_emptyList() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_nullInList() throws JsonProcessingException {
        assertEquals(objectMapper.readValue("{\"type\":\"list\",\"value\":[1,null]}", Object.class),
                Utils.newArrayList(1, null));
    }

    @Test
    void test_deserialize_valid_int_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_string_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_boolean_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_uuid_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_deserialize_valid_emptySet() throws JsonProcessingException {
        assertEquals(
