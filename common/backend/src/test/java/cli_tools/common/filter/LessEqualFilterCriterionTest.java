...
public class LessEqualFilterCriterionTest {
    ...
    @Test
    void test_lessEqual_string() throws PropertyException, IOException {
    ...
    @Test
    void test_notLessEqual_string() throws PropertyException, IOException {
        Mockito.when(propertyOwner.getProperties()).thenReturn(Utils.newHashMap("test_string", "str1"));
        assertNotLessEqualNullsFirst("test_string", "str0");
    }

    @Test
    void test_lessEqual_boolean() throws PropertyException, IOException {
    ...
    @Test
    void test_notLessEqual_boolean() throws PropertyException, IOException {
    ...
    @Test
    void test_lessEqual_integer() throws PropertyException, IOException {
    ...
    @Test
    void test_notLessEqual_integer() throws PropertyException, IOException {
    ...
    @Test
    void test_lessEqual_withNulls() throws PropertyException, IOException {
