...
public class JsonRepositoryTest {
    ...
    @Test
    void test_get_successful() throws IOException {
    ...
    @Test
    void test_fileNotExists_returnEmpty() throws IOException {
        repository = rc.createRepository(new File("/this/path/does/not/exist"));
        assertEquals(repository.getData().size(), 0);
    }

    @Test
    void test_fileEmpty_throwsException() throws IOException {
