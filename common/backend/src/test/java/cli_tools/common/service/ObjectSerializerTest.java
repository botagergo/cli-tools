...
public class ObjectSerializerTest {
    ...
    @Test
    void test_serialize_valid_int() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(123), "123");
    }

    @Test
    void test_serialize_valid_boolean() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(true), "true");
        assertEquals(objectMapper.writeValueAsString(false), "false");
    }

    @Test
    void test_serialize_valid_string() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(""), "\"s:\"");
        assertEquals(objectMapper.writeValueAsString("str"), "\"s:str\"");
    }

    @Test
    void test_serialize_valid_uuid() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(uuid1), "\"u:" + uuid1 + "\"");
    }

    @Test
    void test_serialize_valid_null() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(null), "null");
    }

    @Test
    void test_serialize_valid_int_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_string_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_boolean_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_uuid_list() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_emptyList() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_nullInList() throws JsonProcessingException {
        assertEquals(objectMapper.writeValueAsString(Utils.newArrayList(1, null)), "{\"type\":\"list\",\"value\":[1,null]}");
    }

    @Test
    void test_serialize_valid_int_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_string_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_boolean_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_uuid_set() throws JsonProcessingException {
        assertEquals(
    ...
    @Test
    void test_serialize_valid_emptySet() throws JsonProcessingException {
        assertEquals(
