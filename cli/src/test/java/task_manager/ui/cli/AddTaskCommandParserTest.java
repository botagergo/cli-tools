...
public class AddTaskCommandParserTest {
    ...
    public void test_parse_onePropertyArg() {
        AddTaskCommand command = parse(getArgList(List.of("task"), List.of(Pair.of("prop", List.of("value")))));
        assertEquals(command.name(), "task");
        assertEquals(command.properties(), List.of(Pair.of("prop", List.of("value"))));
    }

    @Test
    public void test_parse_onePropertyArgWithoutName() {
        AddTaskCommand command = parse(getArgList(List.of(), List.of(Pair.of("prop", List.of("value")))));
        assertEquals(command.name(), "");
        assertEquals(command.properties(), List.of(Pair.of("prop", List.of("value"))));
    }
    ...
    public void test_parse_onePropertyArgWithMultipleValues() {
        AddTaskCommand command = parse(getArgList(List.of("task"), List.of(Pair.of("prop", List.of("value1", "value2", "value3")))));
        assertEquals(command.name(), "task");
        assertEquals(command.properties(), List.of(Pair.of("prop", List.of("value1", "value2", "value3"))));
    }
    ...
    private ArgumentList getArgList(List<String> normalArgs, List<Pair<String, List<String>>> propertyArgs) {
