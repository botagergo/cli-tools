...
public class DeleteLabelCommandParserTest {
    ...
    private final DeleteLabelCommandParser parser = new DeleteLabelCommandParser();
    ...
    void test_parse_trailingPositionalArgs() throws CommandParserException {
        DeleteLabelCommand command = (DeleteLabelCommand) parser.parse(context, getArgList("status", List.of("label1", "label2")));
    ...
    void test_parse_noTrailingPositionalArgs() throws CommandParserException {
        DeleteLabelCommand command = (DeleteLabelCommand) parser.parse(context, getArgList("status", null));
    ...
    private ArgumentList getArgList(String type, List<String> trailingPositionalArguments) {
        ...
        argList.setCommandName("deleteLabel");
        if (type != null) {
