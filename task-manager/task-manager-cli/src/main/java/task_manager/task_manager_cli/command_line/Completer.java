...
class Completer implements org.jline.reader.Completer {
    ...
    public void complete(LineReader lineReader, ParsedLine parsedLine, List<Candidate> list) {
        ...
        if (colonIndex == -1) {
            ...
            try {
                properties = context.getPropertyDescriptorUseCase().getPropertyDescriptors()
            ...
            try {
                propertyDescriptor = context.getPropertyDescriptorUseCase().findPropertyDescriptor(argName);
