...
public interface TaskUseCase {
    ...
    Task modifyTask(@NonNull UUID taskUuid, @NonNull Task task) throws IOException, TaskUseCaseException;

    void deleteTask(@NonNull UUID uuid) throws IOException, TaskUseCaseException;
