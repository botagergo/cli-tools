...
public class TaskUseCaseImplTest {
    ...
    @Test
    public void test_getTasks_uuids_empty() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null, null, null,
                List.of()
    ...
    @Test
    public void test_getTasks_uuids_notExist() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null, null, null,
                List.of(uuid1, uuid4)
    ...
    @Test
    public void test_getTasks_uuids_duplicate() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null, null, null,
    ...
    @Test
    public void test_getTasks_uuids() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null, null, null,
                List.of(uuid3, uuid1)
    ...
    @Test
    public void test_getTasks_filterCriterionInfo() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null, null,
    ...
    @Test
    public void test_getTasks_filterPropertySpecs() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                List.of(
    ...
    @Test
    public void test_getTasks_sortingInfo() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        initTasks();
        List<Task> tasks = taskUseCase.getTasks(
                null,
    ...
    @Test
    public void test_getTasks_complex() throws IOException, PropertyException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        simpleTaskRepository.deleteAll();
    ...
    @Test
    public void test_modifyTask() throws IOException, TaskUseCaseException {
        initTasks();
    ...
    @Test
    public void test_modifyTask_empty() throws IOException, TaskUseCaseException {
        initTasks();
    ...
    @Test
    public void test_modifyTask_propertyNotExist() throws IOException, TaskUseCaseException {
        initTasks();
    ...
    public void test_modifyTask_notExist() {
        initTasks();
        assertThrows(TaskUseCaseException.class, () -> taskUseCase.modifyTask(uuid4, Task.fromMap(Utils.newHashMap("done", false, "name", "do something"))));
    }

    @Test
    public void test_deleteTask() throws IOException, TaskUseCaseException {
        initTasks();
    ...
    public void test_deleteTask_notExist() {
        initTasks();
        assertThrows(TaskUseCaseException.class, () -> taskUseCase.deleteTask(uuid4));
    }

    @Test
    public void test_getTaskHierarchies() throws PropertyException, IOException, PropertyConverterException, FilterCriterionException, TaskUseCaseException {
        simpleTaskRepository.deleteAll();
        simpleTaskRepository.getTasks().addAll(List.of(
    ...
    private void addPropertyDescriptor(String name, PropertyDescriptor.Type type) {
        propertyManager.getPropertyDescriptorCollection().addPropertyDescriptor(new PropertyDescriptor(name,
                type, null, PropertyDescriptor.Multiplicity.SINGLE, null, false));
    }
